...
export const GoToContact: React.FC<{}> = () => {
    return (
        <div>
            ...
            <div className='flex flex-wrap items-center justify-center gap-4 rounded-xl bg-white py-6 px-8 shadow-xl lg:justify-between lg:px-20'>
                <div>
                    <h3 className='text-center text-xl font-semibold lg:text-left'>Vous souhaitez me contacter ?</h3>
